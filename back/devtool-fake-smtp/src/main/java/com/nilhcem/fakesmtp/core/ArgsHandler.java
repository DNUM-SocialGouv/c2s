...
public enum ArgsHandler {
	...
	private static final String OPT_MEMORYMODE_DESC = "Disable the listener in order to avoid the overhead that it adds";
	...
	/**
	 * @return whether or not the SMTP server should disable the listener in order to avoid the overhead that it adds.
