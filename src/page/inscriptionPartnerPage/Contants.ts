...
export type AppActions = UpdateFormDataAction | FetchCompanyInfoRequestAction | FetchCompanyInfoSuccessAction | FetchCompanyInfoFailureAction | ResetFormDataAction | FetchDataSuccessAction | FetchDataErrorAction | FetchSubmitRequest;
