...
const FormComponent = () => {
  ...
  // @ts-ignore
  const { companyInfo, isLoading, isClicked, isLoadingSubmit, error } = useSelector((state: RootState) => state.inscription);
                ...
                <div className="fr-fieldset__element fr-fieldset__element--inline">
                  <div className="fr-checkbox-group">
                    ...
                    <label className="fr-label" htmlFor="checkboxes-inline-1">
                      ...
                      éventuel, consultation et archivage par les
                      administrateurs
                    </label>
                    <div
