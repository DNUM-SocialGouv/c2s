            ...
            <div className='dialog-off-canvas-main-canvas'>
                {error &&
                    <div className="fr-alert fr-alert--error fr-alert--sm">
                        <p>Erreur lors de l'enregistrement : veuillez contacter l'administrateur</p>
                    </div>
                }
                <Header/>
                <div className="flex flex-col md:flex-row">
                    ...
                    <div className="flex flex-col lg:gap-2 w-full items-center px-5 md:px-20 md:py-10">
                                            ...
                                            </div>
                                            {
                                                formData.siren.length === 9 && (
                                                    isLoading ? (
                                                        ...
                                                        >
                                                            {isClicked ? <CheckCircleIcon
                                                                className="text-green-700 text-2xl mr-1"/> : null}
                                                            {companyInfo}
                                                        </label>
                                                    )
                                                )
