...
const RequestResetPasswordPage = () => {
    ...
    // @ts-ignore
    const { error, sentRequestSuccess,isLoading }= useSelector(state => state.resetPasswordState);
            ...
            <div className="flex flex-col md:flex-row">
                ...
                <div className="flex flex-col gap-8 w-full items-center px-5 md:px-20 md:py-10 mb-8 md:mb-0 mt-8 md:mt-0">
                    <div className="w-full max-w-4xl mx-auto">
                        <h2 className="fr-h2 text-left mb-8">Réinitialisation du mot de passe</h2>
                        <div className='register-form '>
                            <form onSubmit={handleSubmitRequest}>
                                ...
                                <SubmitButton buttonLabel="Réinitialiser votre mot de passe"
                        ...
                        <>
                            <div className="w-full max-w-4xl mx-auto space-y-10">
                                <div className="fr-alert fr-alert--success">
                                    <p>Si cet identifiant correspond bien à un compte, un e-mail vous a été envoyé pour
                                        vous
                                        permettre de réinitialiser votre mot de passe.</p>
                                </div>
